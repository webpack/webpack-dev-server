...
/* eslint-disable line-comment-position, no-continue, no-use-before-define, no-shadow, no-plusplus, no-unused-vars, no-multi-assign */

const validateOptions = require('schema-utils');
const schema = require('webpack/schemas/plugins/ProgressPlugin.json');
...
class ProgressPlugin {
  ...
  apply(compiler) {
    ...
    if (compiler.compilers) {
      ...
      compiler.hooks.compilation.tap('ProgressPlugin2', (compilation) => {
        ...
        compilation.hooks.buildModule.tap('ProgressPlugin2', moduleAdd);
        compilation.hooks.failedModule.tap('ProgressPlugin2', moduleDone);
        compilation.hooks.succeedModule.tap('ProgressPlugin2', moduleDone);

        compilation.hooks.addEntry.tap('ProgressPlugin2', entryAdd);
        compilation.hooks.failedEntry.tap('ProgressPlugin2', entryDone);
        compilation.hooks.succeedEntry.tap('ProgressPlugin2', entryDone);
      ...
      compiler.hooks.done.tap('ProgressPlugin2', () => {
        handler(1, '');
      });
    }
  }
