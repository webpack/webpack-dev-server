...
import validateOptions from "./options.check.js";
...
class Server {
  ...
  constructor(options, compiler) {
    ...
    // `schema-utils` would otherwise spend ~120ms compiling on every startup.
    // Rejected options go through `schema-utils` for the readable message.
