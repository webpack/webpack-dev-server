 ...
 * @property {(middlewares: Middleware[], devServer: typeof Server) => Middleware[]} [setupMiddlewares]
 */
...
class Server {
  ...
  setupMiddlewares() {
    ...
    if (this.options.proxy) {
       ...
       * ]
       */
      /** @type {Array<ProxyConfigArray | ((req?: Request, res?: Response, next?: NextFunction) => ProxyConfigArray)>} */
