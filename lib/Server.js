 ...
 * @property {WatchOptions & WebpackConfiguration["watchOptions"]} [options]
 */
 ...
 * @property {boolean | WatchOptions & WebpackConfiguration["watchOptions"]} [watch]
 */
 ...
 * @property {ServeIndexOptions} serveIndex
 * @property {ServeStaticOptions} staticOptions
 * @property {WatchOptions} watch
 */
 ...
 * @property {ProxyConfigMap | ProxyConfigArray} [proxy]
...
class Server {
  ...
  addAdditionalEntries(compiler) {
    ...
    if (this.options.client && isWebTarget) {
      ...
      if (this.options.webSocketServer) {
        ...
        if (
          typeof (
            /** @type {TODO} */ (this.options.client).webSocketURL.protocol
          ) !== "undefined"
        ) {
          protocol =
            /** @type {WebSocketURL} */
        ...
        if (
          typeof (
            /** @type {TODO} */ (this.options.client).webSocketURL.username
          ) !== "undefined"
        ) {
          searchParams.set(
            "username",
        ...
        if (
          typeof (
            /** @type {TODO} */ (this.options.client).webSocketURL.password
          ) !== "undefined"
        ) {
          searchParams.set(
            "password",
        ...
        if (
          typeof (
            /** @type {TODO} */ (this.options.client).webSocketURL.hostname
          ) !== "undefined"
        ) {
          hostname =
            /** @type {WebSocketURL} */
        ...
        // Web socket server works on custom `hostname`, only for `ws` because `sock-js` is not support custom `hostname`
          ...
          typeof (
            /** @type {TODO} */ (this.options.webSocketServer).options.host
          ) !== "undefined" &&
          !isSockJSType
        ) {
          hostname =
        ...
        if (
          typeof (
            /** @type {TODO} */ (this.options.client).webSocketURL.port
          ) !== "undefined"
        ) {
          port =
            /** @type {WebSocketURL} */
        ...
        // Web socket server works on custom `port`, only for `ws` because `sock-js` is not support custom `port`
          ...
          typeof (
            /** @type {TODO} */
            (this.options.webSocketServer).options.port
          ) !== "undefined" &&
          !isSockJSType
        ) {
          port = /** @type {TODO} */ (this.options.webSocketServer).options
            .port;
        }
        ...
        if (
          typeof (
            /** @type {TODO} */ (this.options.client).webSocketURL.pathname
          ) !== "undefined"
        ) {
          pathname =
            /** @type {WebSocketURL} */
        ...
        // Web socket server works on custom `path`
          ...
          typeof (
            /** @type {TODO} */ (this.options.webSocketServer).options.prefix
          ) !== "undefined" ||
          typeof (
            /** @type {TODO} */ (this.options.webSocketServer).options.path
          ) !== "undefined"
        ) {
          pathname =
            /** @type {TODO} */
        ...
        if (
          typeof (
            /** @type {ClientConfiguration} */ (this.options.client).logging
          ) !== "undefined"
        ) {
          searchParams.set(
            "logging",
  ...
  async normalizeOptions() {
    ...
    if (
      ...
      typeof (/** @type {TODO} */ (options.server.options).spdy) === "undefined"
    ) {
      /** @type {TODO} */
    ...
    if (options.server.type === "https" || options.server.type === "spdy") {
      ...
      for (const property of httpsProperties) {
        ...
        (options.server).options[property] = Array.isArray(value)
          ? value.map((item) => readFile(/** @type {TODO} */ (item)))
          : readFile(/** @type {TODO} */ (value));
      }
      ...
      if (!Array.isArray(options.proxy)) {
        if (
          ...
          (options.proxy) = Object.keys(options.proxy).map((context) => {
            ...
            if (
              typeof (/** @type {TODO} */ (options.proxy)[context]) === "string"
            ) {
              proxyOptions = {
                context: correctedContext,
                target: /** @type {TODO} */ (options.proxy)[context],
              };
            } else {
              proxyOptions = {
                .../** @type {TODO} */ (options.proxy)[context],
              };
    ...
    if (typeof options.webSocketServer === "undefined") {
      ...
      if (
        typeof (/** @type {TODO} */ (options.webSocketServer).options.port) ===
        "string"
      ) {
        /** @type {TODO} */
   ...
   */
  setupProgressPlugin() {
    // TODO fix me for multi compiler mode
    // @ts-ignore
  ...
  async initialize() {
    ...
    (this.webSocketProxies).forEach((webSocketProxy) => {
      ...
      (this.server).on("upgrade", /** @type {TODO} */ (webSocketProxy).upgrade);
    }, this);
  }
  ...
  setupApp() {
    ...
    this.app = new /** @type {TODO} */ (express)();
  }
  ...
  setupHostHeaderCheck() {
    ...
    (this.app).all(
       ...
       */
      (req, res, next) => {
        if (this.checkHeader(/** @type {TODO} */ (req.headers), "host")) {
          return next();
        }
  ...
  setupMiddlewares() {
    ...
    if (this.options.proxy) {
      ...
      (this.options.proxy).forEach(
        /**
         * @param {TODO} proxyConfigOrCallback
         */
  ...
  createWebSocketServer() {
    /** @type {TODO} */
    this.webSocketServer = new /** @type {TODO} */ (this.getServerTransport())(
      this
    );
    this.webSocketServer.implementation.on(
      "connection",
      /**
       * @param {import("ws").WebSocket | import("sockjs").Connection} client
