...
function Server(compiler, options) {
	...
	this.listeningApp = options.https
		? https.createServer({
				...
				key: fs.readFileSync(sslPaths.key || path.join(__dirname, "../ssl/server.key")),
				cert: fs.readFileSync(sslPaths.cert || path.join(__dirname, "../ssl/server.crt")),
				ca: fs.readFileSync(sslPaths.ca || path.join(__dirname, "../ssl/ca.crt")),
				requestCert: true,
