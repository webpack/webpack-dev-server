...
const overwriteWebpackConfig = require('./utils/overwriteWebpackConfig');
...
class Server {
  constructor(compiler, options = {}) {
    ...
    this.configArr = getCompilerConfigArray(this.compiler);
    overwriteWebpackConfig(this.configArr);
  ...
  showStatus() {
    ...
    const colors = getColorsOption(this.configArr);
  ...
  getStats(statsObj) {
    ...
    const statsOption = getStatsOption(this.configArr);
