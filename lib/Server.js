...
class Server {
  ...
  serveMagicHtml(req, res, next) {
    ...
    try {
      ...
      const responsePage = `<!DOCTYPE html><html><head><meta charset="utf-8"/></head><body><script type="text/javascript" charset="utf-8" src="${_path}.js${req
        ._parsedUrl.search || ''}"></script></body></html>`;
