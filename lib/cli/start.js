...
function listen(argv, options, log, devServer) {
...
module.exports = function start(argv, devServerOptions, log, webpackOptions) {
  ...
  try {
    ...
    if (e instanceof webpack.WebpackOptionsValidationError) {
      ...
      log.error(message); // eslint-disable-line
  ...
  listen(argv, devServerOptions, log, server);
};
