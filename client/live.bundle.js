...
with (locals || {}) {
var interp;
buf.push('<div class="header"><span id="okness"></span>');
var __val__ = " "
buf.push(escape(null == __val__ ? "" : __val__));
buf.push('<span id="status"></span></div><pre id="errors"></pre><div id="warnings"></div><iframe id="iframe" src="javascript:;"></iframe>');
}
return buf.join("");
}
...
exports.rethrow = function rethrow(err, filename, lineno){
  ...
  var context = 3
    , str = require(8).readFileSync(filename, 'utf8')
    , lines = str.split('\n')
...
/******/ /* WEBPACK FREE VAR INJECTION */ (function(module) {
...
/******/ /* WEBPACK FREE VAR INJECTION */ }(require(/* __webpack_module */1)(module)))
