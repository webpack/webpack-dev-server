...
describe("host", () => {
  ...
  for (let host of hosts) {
    test(`should work using "${host}" host and port as number`, async ({ page }) => {
    ...
    test(`should work using "${host}" host and port as string`, async ({ page }) => {
      const compiler = webpack(config);
    ...
    test(`should work using "${host}" host and "auto" port`, async ({ page }) => {
      const compiler = webpack(config);
