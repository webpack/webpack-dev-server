...
describe("web socket communication", () => {
  ...
  webSocketServers.forEach((websocketServer) => {
    test(`should work and close web socket client connection when web socket server closed ("${websocketServer}")`, async ({ page }) => {
    ...
    test(`should work and terminate client that is not alive ("${websocketServer}")`, async ({ page }) => {
    ...
    test(`should work and reconnect when the connection is lost ("${websocketServer}")`, async ({ page }) => {
      WebsocketServer.heartbeatInterval = 100;
